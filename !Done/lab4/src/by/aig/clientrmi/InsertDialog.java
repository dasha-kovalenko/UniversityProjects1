...
public class InsertDialog extends JDialog implements ActionListener{
	...
	public InsertDialog(JFrame frame, String title, boolean modal) {
		// TODO Auto-generated constructor stub
		super(frame,title,modal);
        setLayout(new GridLayout(5,1));
        
        team1Field = new JTextField(60);
        team1Field.setFont(new Font("Comic Sans MS",Font.PLAIN, 14));
        team1Field.setForeground(new Color(139,0,139));
        team1Field.setBorder(BorderFactory.createTitledBorder("Enter the name of the first team"));
        team2Field = new JTextField(40);
        team2Field.setBorder(BorderFactory.createTitledBorder("Enter the name of the second team"));
        ...
        team1Area.setBorder(BorderFactory.createTitledBorder("Enter the name of the first team"));
        ...
        team2Area.setBorder(BorderFactory.createTitledBorder("Enter the name of the second team"));
       ...
       // fieldPanel.add(team1Field);
       // fieldPanel.add(team2Field);
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if(ev.getActionCommand().equals("Insert")){
