...
public interface IPeriodicalsEditionsDAO {
	...
	public void addEditionToCart(long cartId, long editionId)throws PeriodicalsDAOException;

	public void deleteEditionFromCart(long cartId, long editionId)throws PeriodicalsDAOException;
