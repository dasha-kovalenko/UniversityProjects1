...
public interface IPeriodicalsUsersDAO {

	public User getUser(long id) throws PeriodicalsDAOException;

	public User getUser(String username, String password) throws PeriodicalsDAOException;
	...
	public void addCartToSubscriptionAndDelete(long cartId) throws PeriodicalsDAOException;

	public void createSubscription(Long userId, Subscription subscription)throws PeriodicalsDAOException;
	...
	public Long getLastSubscriptionFromUser(long userId) throws PeriodicalsDAOException;
