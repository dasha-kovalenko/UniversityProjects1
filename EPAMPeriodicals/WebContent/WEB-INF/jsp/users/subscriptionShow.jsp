...
<title><fmt:message key="editionListOfSubscription" /></title>
</head>
<body>
	...
	<div class="container">
		<div class="content">
			<div class="row">
				<div class="span9">
					<jsp:include page="/WEB-INF/jsp/application/message.jsp" />
					<jsp:include page="/WEB-INF/jsp/users/_subscriptionShow.jsp"
						flush="true" />
				</div>
				<div class="span1">&nbsp;</div>
				<div class="span3">
