...
<title><fmt:message key="editionList" /></title>
</head>
<body>
		...
		<div class="content">
			<div class="row">
				<div class="span9">
					...
					<jsp:include page="/WEB-INF/jsp/application/message.jsp" flush="true" />
					<jsp:include page="/WEB-INF/jsp/editions/_list.jsp" flush="true" />
				</div>
				<div class="span1">&nbsp;</div>
				<div class="span3">
