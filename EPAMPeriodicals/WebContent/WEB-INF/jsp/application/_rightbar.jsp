	...
	<div class="well sidebar-nav">
		...
		<ul class="nav nav-list">
			...
			<c:if test="${sessionScope.admin}">
				<li><c:url value="periodicals?command=editionCreate"
						var="createUrl" /> <!-- 	<a href="periodicals?command=editionCreate"/>  -->
					<a href="${ createUrl}" /> <span class="label label-info"><fmt:message
							key="createEdition" /></span></li>
			</c:if>
