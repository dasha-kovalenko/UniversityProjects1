...
/**
 * Class <code>UserGetSubscriptionsCommand</code> is used to display
 ...
 * <code>UserGetSubscriptionsCommand</code> implements {@link ICommand
...
public class UserGetSubscriptionsCommand implements ICommand {
	private static Logger log = Logger
			.getLogger(UserGetSubscriptionsCommand.class);
